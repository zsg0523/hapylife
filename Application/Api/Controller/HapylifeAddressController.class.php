    ...
    **/
    public function addresslist(){
        if(!IS_POST){
            ...
            if(!in_array($userinfo['shopaddress1'], $ia_road) && $userinfo['is_login'] == 0 && !empty($userinfo['shopaddress1']) && !empty($userinfo['shopprovince']) && !empty($userinfo['sopcity']) && !empty($userinfo['shoparea'])){
               $message = array(
                    'iuid'            => $userinfo['iuid'],
